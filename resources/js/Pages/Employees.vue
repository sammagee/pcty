                        ...
                        <div class="divide-y divide-gray-100">
                            <div class="grid items-center grid-cols-4 px-6 py-4 space-x-2 md:grid-cols-5" v-for="employee in employees.data" :key="employee.id">
                                ...
                                <div class="flex items-center justify-end space-x-3">
                                    ...
                                    <button class="text-red-500 hover:text-red-700 focus:outline-none focus:ring-2 focus:ring-red-300" @click="deleteEmployee(employee.id)">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const deleteEmployee = id => Inertia.delete(route('employee.destroy', id))
